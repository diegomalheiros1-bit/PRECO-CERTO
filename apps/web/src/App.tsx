...
export function App() {
  ...
  function editPrice(item: Listing, value: string) { setPrices(previous => updateGroupPrice(previous, item, searchResult, value)); }
